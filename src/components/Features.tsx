            ...
            <Box m={8} display="flex" flexWrap="wrap" justifyContent="space-between" w="80%" textAlign="left">
                <Flex width={{ base: "100%", md: "45%" }} textAlign="left" justifyContent="center" alignItems="center" mb={12}>
                    <Box>
                        ...
                        <Text mt={4} fontSize="2xl" fontWeight="bold" color={colorMode === "light" ? "black" : "white"}>Clean up your tech debt, automatically</Text> {/* Change the color of the text based on the color mode */}
                        <Text mt={4} fontSize="md" color={colorMode === "light" ? "black" : "lightgrey"}>Sweep generates repository-level code at your command. Cut down your dev time on mundane tasks, like tests, documentation, and refactoring.</Text> {/* Change the color of the text based on the color mode */}
                    </Box>
                </Flex>
