...
export default function Features() {
    return (
        <>
            <Box display="flex" justifyContent="center" alignItems="center" mb={96} p={8}>
                <Box m={8} display="flex" flexWrap="wrap" justifyContent="space-between" w={{base: "100%", md: "80%"}} textAlign="left" p={8}>
                    <Flex width={{ base: "100%", md: "45%" }} textAlign="left" justifyContent="center" alignItems="center" mb={12} p={8}>
                        <Box>
            ...
            <Box display="flex" justifyContent="center" alignItems="center" mb={96} p={8}>
                <Box m={8} display="flex" flexWrap="wrap" justifyContent="space-between" w={{base: "100%", md: "80%"}} textAlign="left" p={8}>
                    ...
                    <Box width={{ base: "100%", md: "45%" }} maxW="100%" mb={12} p={8}>
            ...
            <Box display="flex" justifyContent="center" alignItems="center" mb={48} p={8}>
                <Box m={8} display="flex" flexWrap="wrap" justifyContent="space-between" w={{base: "100%", md: "80%"}} textAlign="left" p={8}>
                    <Flex width={{ base: "100%", md: "45%" }} textAlign="left" justifyContent="center" alignItems="center" mb={12} p={8}>
                        <Box>
                            <FaGithub size={40} />
