        ...
        return (
            ...
            >
                <Flex width="100%" m={2} mb={4}>
                    <User><Text color="white">{this.props.name.split(' ').map(n => n[0]).join('').toUpperCase()}</Text></User>
                    <Box flexGrow={1} textAlign="left" ml={4}>
                        <Text fontWeight="bold">{this.props.name}</Text>
                        <ExternalLinkWithText href={this.props.href} color="#aaa">{this.props.company}</ExternalLinkWithText>
                    </Box>
                </Flex>
