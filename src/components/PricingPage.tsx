    ...
    <SimpleGrid columns={{ base: 1, md: 3 }} spacing={10}>
      ...
      >
        <Box>
          ...
          <Box as="ul" style={{ listStyleType: "none" }}>
            ...
            <li>
              <em>
                Purchase additional GPT-4 tickets{" "}
                <Link
                  href="https://buy.stripe.com/00g3fh7qF85q0AE14d"
                  color="#89CFF0"
                >
                  here
                </Link>
        ...
        <Button
          ...
          mt={12}
          onClick={() =>
            window.open("https://github.com/apps/sweep-ai", "_blank")
          }
        >
          Install
        </Button>
      ...
      >
        ...
        <Button
          ...
          mt={12}
          onClick={() =>
            window.open("https://buy.stripe.com/6oE5npbGVbhC97afZ4", "_blank")
          }
        >
          Purchase
        </Button>
      ...
      >
        ...
        <Button
          ...
          mt={12}
          onClick={() =>
            window.open("https://form.typeform.com/to/wliuvyWE", "_blank")
          }
        >
          Contact us
        </Button>
