...
const PullRequestLink = ({
  ...
  return (
    <Text>
      ...
      <Box ml={8}>
        <ExternalLinkWithText href={href}>{children}</ExternalLinkWithText>
      </Box>
    </Text>
  );
};
...
const Example = ({
  ...
  return (
    <Box overflow="hidden" p={4} width={{ base: "100%", md: "30%" }} mb={8}>
      <Text fontSize="lg" textAlign="left">
        ...
        <Comment src={avatar_href} username={username}>
          {issue_description}
        </Comment>
        <Comment src={logo} username="sweep-ai">
          {children}
        </Comment>
      ...
      <>
        <Box display="flex" justifyContent="center" alignItems="center">
          <Box m={8} mt={32} width={{ base: "100%", md: "80%" }}>
            <Text fontSize="5xl" fontWeight="bold" mb={12} textAlign="center">
              Example tickets handled by Sweep
            </Text>
            <Box display="flex" flexWrap="wrap" justifyContent="space-between">
              ...
              >
                ...
                <ul style={{ marginLeft: 20, marginTop: 10 }}>
                  ...
                  <li>Add verbosity and color options using typer</li>
                </ul>
              </Example>
              <Example
                repo_name="edreisMD/plugnplai"
              ...
              >
                ...
                <ul style={{ marginLeft: 20, marginTop: 10 }}>
                  <li>
                    Add a max_plugins attribute to the Plugins class and set it
                    to 3
                  </li>
                  <li>Add logic to limit activating plugins to max_plugins</li>
                  <li>
                    Potentially refactor the activate() method to handle this
                    logic
                  </li>
                </ul>
              </Example>
              ...
              >
                Hey @kevinlu1248,
                <br />
                I've started working on writing tests for the MiniChain library.
                The plan is to add test files for the core Backend, BasePrompt,
                and Gradio classes to cover normal usage and edge cases. I'll be
                using the pytest framework to write and run the tests.
              </Example>
            </Box>
          </Box>
        </Box>
        <Text mb={16}>
          ...
          <ExternalLinkWithText href="https://docs.sweep.dev/examples">
