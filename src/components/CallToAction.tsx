...
export default class CallToAction extends React.Component<{}, { spin: boolean }> {
  constructor(props: {}) {
    super(props);
    this.state = {
      spin: false,
  ...
  render() {
    return (
      ...
      <Stack
        ...
        mb={36}
      >
        <img src={logo} alt="Logo" style={{ width: '200px', animation: this.state.spin ? "spin 0.5s linear" : "bob 0.75s ease-in-out infinite alternate", marginTop: "-2rem !important", borderRadius: "50%" }} onClick={this.handleClick.bind(this)} />
