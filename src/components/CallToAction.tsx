  ...
  return (
    <Container maxW={"5xl"}>
      ...
      >
        ...
        <Text color={colorMode === "light" ? "black" : "purple.400"} maxW={"3xl"} mt="1rem !important" mb="1rem !important">
          Spend time reviewing code generated by AI, not writing it
        </Text>
        <Button
          color={colorMode === "light" ? "black" : "white"}
          p={6}
          colorScheme={colorMode === "light" ? "blackAlpha" : "purple"}
          bg={colorMode === "light" ? "white" : "purple.400"}
          _hover={{ bg: colorMode === "light" ? "gray.200" : "purple.600" }}
        ...
        <ExternalLinkWithText
          ...
          color={colorMode === "light" ? "black" : "purple.400"}
          mt="0 !important"
          style={{
            display: "flex",
            flexDirection: "row",
