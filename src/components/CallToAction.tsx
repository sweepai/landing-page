  ...
  return (
    <Container maxW={"5xl"}>
      <Stack
        ...
        mb={36}
      >
        <img src={logo} alt="Logo" style={{ width: '100px', animation: spin ? "spin 0.5s linear" : "bob 0.75s ease-in-out infinite alternate", marginTop: "-2rem !important", borderRadius: "50%" }} onClick={async () => {
            setSpin(!spin);
