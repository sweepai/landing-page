...
export default class CallToAction extends Component {
  static logo = require("../assets/icon.png");
  state = { spin: false };
  ...
  return (
    <Container maxW={"5xl"}>
      <Stack
        ...
        mb={36}
      >
        <img src={this.constructor.logo} alt="Logo" style={{ width: '200px', animation: this.state.spin ? "spin 0.5s linear" : "bob 0.75s ease-in-out infinite alternate", marginTop: "-2rem !important", borderRadius: "50%" }} onClick={this.handleClick} />
