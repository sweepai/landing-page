...
const buttonBgColor = useColorModeValue("black", "purple.400");
const buttonHoverColor = useColorModeValue("gray.700", "purple.600");
  ...
  return (
    <Container maxW={"5xl"}>
      ...
      >
        ...
        <Text color={textColor} maxW={"3xl"} mt="1rem !important" mb="1rem !important">
          Spend time reviewing code generated by AI, not writing it
        </Text>
        <Button color="white" p={6} bg={buttonBgColor} _hover={{ bg: buttonHoverColor }} onClick={() => window.open("https://github.com/apps/sweep-ai")} fontSize={"xl"} mb="1rem !important">
          color="white"
          p={6}
          colorScheme={"purple"}
          bg={"purple.400"}
